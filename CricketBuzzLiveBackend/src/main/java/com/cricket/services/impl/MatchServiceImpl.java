...
import com.cricket.repositories.MatchRepo;
...
//                update the match in database
	...
	public List<List<String>> getPointTable() {
        ...
        // Replace the year in the URL dynamically
        String tableURL = "https://www.cricbuzz.com/cricket-series/6732/icc-cricket-world-cup-" + currentYear + "/points-table";
        		try {
